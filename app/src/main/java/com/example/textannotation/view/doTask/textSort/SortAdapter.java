...
import com.example.textannotation.view.doTask.textSort.component.ExpandableTextView;
import com.example.textannotation.view.doTask.textSort.component.ItemTouchHelperAdapter;
import com.example.textannotation.view.doTask.textSort.util.DataBean;

import java.util.Collections;
import java.util.List;

public class SortAdapter extends RecyclerView.Adapter<SortAdapter.MyViewHolder> implements ItemTouchHelperAdapter {
    ...
    public SortAdapter(List<DataBean> list) {
        this.list = list;
    }
