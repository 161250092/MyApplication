 ...
 */
public class TextMatchBelowAdapter extends FragmentPagerAdapter {

    FragmentManager fm;
    private List<TextMatchBelowFragment> list;
    private ArrayList<Content> array;
    //private List<String> stringList;

    public TextMatchBelowAdapter(FragmentManager fm, List<TextMatchBelowFragment> list) {
        super(fm);
        this.fm=fm;
        this.list = list;
