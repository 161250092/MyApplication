...
import com.example.textannotation.view.doTask.textMatch.TextTextMatchFragment;
 ...
 */
public class TextMatchBelowFragment extends BaseLazyFragment {
    /**
    ...
    public TextMatchBelowFragment() {
    }


    //新建Fragment
    public static TextMatchBelowFragment newInstance(int sectionNumber) {
        TextMatchBelowFragment fragment = new TextMatchBelowFragment();
                ...
                if (mViewInflateFinished) {
                    ...
                    selectbtn.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View v) {
                            TextTextMatchFragment textMatchFragment =(TextTextMatchFragment)getParentFragment();
                            if (textMatchFragment != null) {
                                int aboveItemId = textMatchFragment.getAboveItemId();
                                int belowItemId = getListitemid();

                                textMatchFragment.addMatchPair(aboveItemId,belowItemId);
                                selectbtn.setVisibility(View.GONE);
                                cancelBtn.setVisibility(View.VISIBLE);

                                int belowIndex = textMatchFragment.getBelowFragmentIndex();
                                textMatchFragment.addMatchInfoInAboveFragment(belowIndex);
                    ...
                    cancelBtn.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View v) {
                            ...
                            if (textMatchFragment != null) {
                                ...
                                textMatchFragment.deleteMatchPair(aboveItemId,belowItemId);
                                selectbtn.setVisibility(View.VISIBLE);
                                cancelBtn.setVisibility(View.GONE);

                                int belowIndex = textMatchFragment.getBelowFragmentIndex();
                                textMatchFragment.minusMatchInfoInAboveFragment(belowIndex);
                            }
