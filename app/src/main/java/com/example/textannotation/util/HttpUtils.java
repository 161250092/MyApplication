...
import com.example.textannotation.util.HttpUtils.HTTP_TYPE;
import com.example.textannotation.util.HttpUtils.PROTOCOL_TYPE;
...
class HttpTask extends AsyncTask<String, Void, String> {
    ...
    public HttpTask(Activity activity, IHttpCallback callback, HTTP_TYPE type, PROTOCOL_TYPE protocolType, String params) {
        super();
        mActivity = activity;
