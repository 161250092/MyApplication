 ...
 */
public class MatchCategoryBlowAdapter extends FragmentPagerAdapter {

    FragmentManager fm;
    private List<MatchCategoryBlowFragment> list;
    private ArrayList<Content> array;
    //private List<String> stringList;

    public MatchCategoryBlowAdapter(FragmentManager fm, List<MatchCategoryBlowFragment> list) {
        super(fm);
        this.fm=fm;
        this.list = list;
