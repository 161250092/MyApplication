...
public class MyListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private void initView(Context context) {
        //拿到头布局xml
        headview=LayoutInflater.from(context).inflate(R.layout.listview_head_layout,null);
        ...
        //拿到尾布局xml
        footview=LayoutInflater.from(context).inflate(R.layout.listview_proces_layout,null);
        //测量footview的高度
