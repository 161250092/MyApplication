...
import com.example.kongmin.view.doTask.categoryMatch.MatchCategoryAboveFragment;
 ...
 */
public class MatchCategoryAboveAdapter extends FragmentPagerAdapter {

    FragmentManager fm;
    private List<MatchCategoryAboveFragment> list;
    private ArrayList<Content> array;
    //private List<String> stringList;

    public MatchCategoryAboveAdapter(FragmentManager fm, List<MatchCategoryAboveFragment> list) {
        super(fm);
        this.fm=fm;
        this.list = list;
