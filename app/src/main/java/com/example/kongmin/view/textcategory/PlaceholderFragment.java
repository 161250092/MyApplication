...
public class PlaceholderFragment extends BaseLazyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View bottomview = (View)rootView.findViewById(R.id.viewinvisible);

        //和item相关的
        TextView textView4 = (TextView) rootView.findViewById(R.id.cancel);
        TextView textView5 = (TextView) rootView.findViewById(R.id.confirm);
        //和设置标签相关的
        view =  rootView.findViewById(R.id.flowgroupview2);
        itemview =  rootView.findViewById(R.id.flowgroupview3);

        //和弹出界面相关的
        slideBottomLayout = (SlideBottomLayout)rootView.findViewById(R.id.slideLayout);
        //pop_fujian = (ImageView)rootView.findViewById(R.id.sc_fujianimg);
        //pop_fujian = (TextView) rootView.findViewById(R.id.complete);

        //textView2.setPadding(0,0,0,slideBottomLayout.getHeight());
        ...
        *//*for(String key:names.keySet()){
        ...
        for (int i = 0; i < itemnames.size(); i++) {
            addItemTextView(itemnames.get(i));
        }
        initData(textView,textView2,textView3,bottomview);
        initItemData(textView4,textView5);
        return rootView;
    }*/
     ...
     * @param str
     */
    /*private void addTextView(String str,FlowGroupView labelview,final LinkedHashMap<String,Integer> hashmap,final List<String> checked,final List<Integer> labelid) {
            ...
            public void run() {
                ...
                if (mViewInflateFinished) {
                    ...
                    if(issorted.equals("true")){
                        ...
                        /*for(int i=0;i<seledinst.size();i++){
                            if(seledinstid.get(i)==instanceid) {
                                delseledinst.add(seledinst.get(i));
                                delseleditem1.add(seleditem1.get(i));
                                delseleditem2.add(seleditem2.get(i));
                                Log.e("DotaskExtract---->", "GET方式请求成功，issorted.equals(true)delseledinst--->" + seledinst);
                            }
                        }*/
                    ...
                    //item1content和item2content的点击事件
                    /*item1content.setOnExpandStateChangeListener(new ExpandableTextView.OnExpandStateChangeListener() {
                        @Override
                        public void onExpandStateChanged(TextView textView, boolean isExpanded) {
                            Toast.makeText(getActivity(), isExpanded ? "Expanded" : "Collapsed", Toast.LENGTH_SHORT).show();
                        }
                    });
                    textView2.setOnExpandStateChangeListener(new ExpandableTextView.OnExpandStateChangeListener() {
                        @Override
                        public void onExpandStateChanged(TextView textView, boolean isExpanded) {
                            Toast.makeText(getActivity(), isExpanded ? "Expanded" : "Collapsed", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    //标记item按钮
                    /*labelitembtn.setOnClickListener(new View.OnClickListener() {

                        @Override
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            if(itemlabelview.getVisibility()==View.VISIBLE){
                                itemlabelview.setVisibility(View.GONE);
                            }else{
                                itemlabelview.setVisibility(View.VISIBLE);
                            }
                        }
                    });*/
