 ...
 * 文本配对标注发任务界面
 */
public class AddListMatchCategoryActivity extends BaseActivity {

    //选择文件的弹出框
    private EmojiKeyboard emojiKeyboard;

    private final String TAG = "文本配对标注发任务";

    public static final String matchtype = "文本配对标注#";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_mcmain);
    ...
    private void initText(){
        ...
        type = (TextView) findViewById(R.id.matchtype);
        typedetail = (RadioGroup) findViewById(R.id.matchtypedetail);
        deadline = (EditText) findViewById(R.id.matchdeadline);
        content = (EditText) findViewById(R.id.matchcontent);
        ...
        typedetail.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group,int checkedId){
                ...
                Toast.makeText(AddListMatchCategoryActivity.this, rb.getText().toString(), Toast.LENGTH_LONG).show();
                tasktypedetail = rb.getText().toString();
            }
        });
        //选择文件按钮
    ...
    private void initView() {
        ...
        //任务内容编辑框
        EditText et_inputMessage = (EditText) findViewById(R.id.matchcontent);
        //打开文件选择
    ...
    private void changeIcon(final int position, final String picturePath) {
        ...
        popupWindow.showAtLocation(AddListMatchCategoryActivity.this.findViewById(R.id.twoitemscontent), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    ...
    Runnable postRun = new Runnable() {
        ...
        public void run() {
            // TODO Auto-generated method stub
            String baseUrl = Constant.matchcategoryaddtaskUrl;
            ...
            if(data.toString().equals("0")){
                // 给btnLogin添加点击响应事件
                Intent intent = new Intent(AddListMatchCategoryActivity.this, MainActivity.class);
                //启动
                startActivity(intent);
                String loginres = jsonObject.getString("msg");
                Looper.prepare();
                Toast.makeText(AddListMatchCategoryActivity.this,loginres,Toast.LENGTH_LONG).show();
                Looper.loop();
            }else{
                //上传的文件不符合要求
            ...
            Intent intent=new Intent(AddListMatchCategoryActivity.this,EditTextListActivity.class);
            startActivity(intent);
            AddListMatchCategoryActivity.this.finish();*/
        }
    };
    ...
    private void isSave(){
        ...
        fileparams.put("typeName",tasktype+tasktypedetail);
