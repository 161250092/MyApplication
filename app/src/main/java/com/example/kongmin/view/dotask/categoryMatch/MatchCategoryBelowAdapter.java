...
import com.example.kongmin.view.doTask.categoryMatch.MatchCategoryBelowFragment;
 ...
 */
public class MatchCategoryBelowAdapter extends FragmentPagerAdapter {

    FragmentManager fm;
    private List<MatchCategoryBelowFragment> list;
    private ArrayList<Content> array;
    //private List<String> stringList;

    public MatchCategoryBelowAdapter(FragmentManager fm, List<MatchCategoryBelowFragment> list) {
        super(fm);
        this.fm=fm;
        this.list = list;
