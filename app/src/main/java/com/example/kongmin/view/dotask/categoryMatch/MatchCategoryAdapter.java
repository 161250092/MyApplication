...
import com.example.kongmin.view.doTask.categoryMatch.MatchCategoryFragment;
 ...
 */
public class MatchCategoryAdapter extends FragmentPagerAdapter {

    FragmentManager fm;
    private List<MatchCategoryFragment> list;
    private ArrayList<Content> array;
    //private List<String> stringList;

    public MatchCategoryAdapter(FragmentManager fm, List<MatchCategoryFragment> list) {
        super(fm);
        this.fm=fm;
        this.list = list;
